...
# ===========================================
# Advanced INteractive an Previewng Aliases =
# ===========================================

alias search="fzf --preview 'bat --color=always --style=numbers --line-range=:500 {}'"
#alias cdf="cd $(find . -type d | fzf)"
#alias dfz="du -achd 1 | fzf --sort"
#alias hfz="history | fzf --preview 'echo {}' | sed -n 's/.*  //p' | xargs -I % sh -c '%'"
#alias pfz="ps aux | fzf | awk '{print $2}' | xargs -I {} kill -9 {}"
#alias dirfz="cd $(dirs -v | fzf --preview 'echo {}' | awk '{print $2}')"
